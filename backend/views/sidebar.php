...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseAppointments" class="collapse" aria-labelledby="headingAppointments"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="admin.php?admin=listTaiKham">Danh Sách Tái Khám</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="admin.php?admin=listTaiKhoanLeTan">Quản Lý Lễ Tân</a>
    ...
    <!-- X-Quang -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseXray"
            aria-expanded="true" aria-controls="collapseXray">
            <i class="fas fa-fw fa-x-ray"></i>
            <span>X-Quang</span>
        </a>
        <div id="collapseXray" class="collapse" aria-labelledby="headingXray" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="admin.php?admin=listXray">Danh Sách X-Quang</a>
            </div>
        </div>
    </li>
