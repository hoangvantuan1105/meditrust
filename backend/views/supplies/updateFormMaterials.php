...
<div class="container-fluid">
    ...
    <!-- Tiêu Đề Trang -->
    <h1 class="h3 mb-2 text-gray-800">Cập nhật vật tư / sản phẩm</h1>
    <p class="mb-4">Điền các thông tin vật tư hoặc sản phẩm vào hệ thống.</p>

    <!-- Form Thêm Người Dùng -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Biểu Mẫu Cập Nhật Vật Tư / Sản Phẩm</h6>
        </div>
        <div class="card-body">
            <form method="POST" action="admin.php?admin=editMaterials">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="type" required>
                            <option value="0" <?= (int)($item['type'] ?? 0) === 0 ? 'selected' : '' ?>>Vật tư</option>
                            <option value="1" <?= (int)($item['type'] ?? 0) === 1 ? 'selected' : '' ?>>Sản phẩm</option>
                        </select>
                    </div>

                    <div class="form-group col-md-6">
                        <label>Trạng thái bán POS</label>
                        <select class="form-control" name="trang_thai_su_dung">
                            <option value="1" <?= (int)($item['trang_thai_su_dung'] ?? 1) === 1 ? 'selected' : '' ?>>Đang bán</option>
                            <option value="0" <?= (int)($item['trang_thai_su_dung'] ?? 1) === 0 ? 'selected' : '' ?>>Khóa</option>
                        </select>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Cập Nhật Vật Tư / Sản Phẩm
                </button>
