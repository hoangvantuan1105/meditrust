...
<div class="container-fluid">
    ...
    <!-- Tiêu Đề Trang -->
    <h1 class="h3 mb-2 text-gray-800">Thêm vật Tư Mới</h1>
    <p class="mb-4">Điền các thông tin vật tư mới vào hệ thống.</p>

    <!-- Form Thêm Người Dùng -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Biểu Mẫu Thêm Vật Tư</h6>
        </div>
        <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6 position-relative">
                        ...
                        <input type="text" class="form-control" id="ten_vat_tu" name="ten_vat_tu"
                            placeholder="Nhập tên vật tư" autocomplete="off" required>
