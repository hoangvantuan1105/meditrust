...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form id="addUserForm" method="POST" action="admin.php?admin=storeDiscount">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="gia_tri" name="gia_tri" placeholder="Nhập giá trị" required>
                        <div id="suggest-box" class="list-group position-absolute w-100" style="z-index:999;"></div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="so_luot" name="so_luot" placeholder="Ví dụ: 100" required>
                        <div id="suggest-box" class="list-group position-absolute w-100" style="z-index:999;"></div>
