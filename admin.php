...
$router->addRouterAdmin("checkPaymentStatus",   "OrderController", "checkPaymentStatus");
...
$router->addRouterAdmin("addBuocDichVu",         "ServiceController", "addBuocDichVu");
$router->addRouterAdmin("editBuocDichVu",        "ServiceController", "editBuocDichVu");
$router->addRouterAdmin("deleteBuocDichVu",      "ServiceController", "deleteBuocDichVu");
...
$router->addRouterAdmin("listTaiKham",             "MedicalRecordController", "listTaiKham");
$router->addRouterAdmin("capNhatTrangThaiTaiKham", "MedicalRecordController", "capNhatTrangThaiTaiKham");
$router->addRouterAdmin("guiNhacNhoTaiKham",       "MedicalRecordController", "guiNhacNhoTaiKham");
$router->addRouterAdmin("guiNhacNhoTatCa",         "MedicalRecordController", "guiNhacNhoTatCa");
...
$router->addRouterAdmin("xoaTaiKhoanLeTan",     "UserManagementController", "xoaTaiKhoanLeTan");

// ===== X-Quang =====
$router->addRouterAdmin("listXray",          "XrayController", "listXray");
$router->addRouterAdmin("formUploadXray",    "XrayController", "formUploadXray");
$router->addRouterAdmin("luuXray",           "XrayController", "luuXray");
$router->addRouterAdmin("viewXray",          "XrayController", "viewXray");
$router->addRouterAdmin("xrayBenhNhan",      "XrayController", "xrayBenhNhan");
$router->addRouterAdmin("luuKetQuaXray",     "XrayController", "luuKetQuaXray");
$router->addRouterAdmin("xoaXray",           "XrayController", "xoaXray");
$router->addRouterAdmin("getXrayByLichKham", "XrayController", "getXrayByLichKham");
$router->addRouterAdmin("reAnalyzeXray",     "XrayController", "reAnalyzeXray");
$router->addRouterAdmin("detailXray",        "XrayController", "detailXray");
